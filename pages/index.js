...
export default function Index() {
  ...
  const gridImages = [
    {
      link: "https://dwxk3eiesmmgs.cloudfront.net/images/IMG_6084.webp",
      altText: "Jeanice doing makeup" //not this one
    },
    {
      link: "https://dwxk3eiesmmgs.cloudfront.net/images/IMG_4037.webp",
      altText: "Bride with dress"
    },
    {
      link: "https://dwxk3eiesmmgs.cloudfront.net/images/IMG_9555.webp",
      altText: "Image of finished makeup"
    },
    {
      link: "https://dwxk3eiesmmgs.cloudfront.net/images/IMG_8632.webp",
      ...
      <main>
        ...
        <Grid container spacing={4} className={styles.aboutWrapper} sx={{ display: 'flex', justifyContent: 'center' }}>
          <Grid item xs={12} sm={6} className={styles.imageWrapper} >
            <Image
              src="https://dwxk3eiesmmgs.cloudfront.net/images/IMG_4382.webp"
            ...
            <Stack spacing={2}>
              ...
              <Stack spacing={2} direction="row" sx={{ width: '100%' }}>
                <Link href="/portfolio#bridal" className={styles.labelBox}>
                  <Box className={styles.labelBox} sx={{ backgroundImage: `url("https://dwxk3eiesmmgs.cloudfront.net/images/IMG_6087.webp")` }}>
                    <Typography> Bridal </Typography>
                  </Box>
                </Link>

                <Link href="/portfolio#studio" className={styles.labelBox}>
                  <Box className={styles.labelBox} sx={{ backgroundImage: `url("https://dwxk3eiesmmgs.cloudfront.net/images/C9FBB259-D95B-4990-9992-CFF20769905C.webp")` }}>
